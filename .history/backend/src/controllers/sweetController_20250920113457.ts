...
import { CreateSweetRequest, UpdateSweetRequest, SweetQuery } from '../types/sweet';
  ...
  try {
    ...
    const sweet = await prisma.sweet.create({
      ...
      include: {
        ...
        // Map to SweetResponse format
    const response: SweetResponse = {
      id: sweet.id,
      name: sweet.name,
      ...
      createdBy: {
        id: sweet.createdBy.id,
        name: sweet.createdBy.name,
        email: sweet.createdBy.email
      }
    };
