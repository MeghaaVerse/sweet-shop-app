...
const Dashboard: React.FC = () => {
  ...
  const filteredSweets = sweets.filter(sweet =>
    ...
    // Sweet button handler
    const handleAddSweet = () => {
    setShowAddModal(true);
    };

    // modal's Add Sweet button
    ...
    notificationService.onSweetAdded(setNewSweetPriceweetName);

    addNotification({
        type: 'info',
        title: 'Sweet Added',
        message: `Sweet "${setNewSweetName}" added successfully.`,
   ...
   setTimeout(() => {
      notificationService.onInventoryUpdated(setNewSweetNameweetName, 'RESTOCK', 50);
      addNotification({
          type: 'success',
          title: 'Inventory Updated',
          message: `Inventory updated: ${sweetName} restocked with 50 units.`,
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            <div className="space-y-4">
                ...
                placeholder="Price"
                value={newSweetPrice}
                onChange={(e) => setNewSweetPrice(Number(e.target.value))}
