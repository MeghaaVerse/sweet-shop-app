...
import { Candy, Eye, EyeOff, Mail, Lock, User, Sparkles, CheckCircle } from 'lucide-react';
                ...
                {formData.password && (
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-sm font-medium ${getStrengthColor(strength).replace('bg-', 'text-')}`}>
