          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl max-h-90vh overflow-y-auto">
            ...
            <form onSubmit={handleAddSweet} className="space-y-4">
              ...
              <input
                ...
                onChange={(e) => setNewSweet({...newSweet, price: e.target.value ? parseFloat(e.target.value) : 0,})}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                required
              />
              ...
              <input
                ...
                onChange={(e) => setNewSweet({...newSweet, stock: e.target.value ? parseInt(e.target.value) : 0})}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
              />
