...
const Dashboard: React.FC = () => {
  ...
  const filteredSweets = sweets.filter(sweet =>
    ...
    // Simulate adding sweet
    const sweetName = 'New Sweet Item'; // Get from form
    
    notificationService.onSweetAdded(sweetName);

    addNotification({
        type: 'info',
        message: `Sweet "${sweetName}" added successfully.`,
        title: ''
    });
   ...
   setTimeout(() => {
      notificationService.onInventoryUpdated(sweetName, 'RESTOCK', 50);
      addNotification({
          type: 'success',
