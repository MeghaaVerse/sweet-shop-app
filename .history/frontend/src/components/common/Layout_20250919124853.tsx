        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <NavLink href="/" icon={<Candy />} text="Sweets" />
              <NavLink href="/inventory" icon={<Package />} text="Inventory" />
              <NavLink href="/analytics" icon={<BarChart3 />} text="Analytics" />
            </nav>
...
const NavLink: React.FC<{ href: string; icon: ReactNode; text: string }> = ({ href, icon, text }) => (
  <a
    href={href}
