    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="absolute right-0 top-12 w-96 max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200 z-[9999] max-h-96 overflow-hidden">
            {/* Header */}
