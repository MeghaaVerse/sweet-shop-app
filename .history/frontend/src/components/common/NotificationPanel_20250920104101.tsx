    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="fixed top-4 right-4 w-96 max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200 z-50 max-h-96 overflow-y-auto">
            {/* Header */}
